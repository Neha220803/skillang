    ...
    return (
        <div className="getting-started-container" ref={componentRef}>
            <div className="header-section">
                <h1 className="heading-big-medium text-content-primary">Getting Started</h1>
                <p className="paragraph-big-regular text-content-secondary">Secure your loan through a streamlined five-step process.</p>
            </div>
            ...
            <div className="progress-steps-container">
                    ...
                    <div className="step-progress-bar">
                        ...
                        <div className="step-item">
                            ...
                            <div className="step-circle">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#dfe1e6" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                                    <polyline points="20 6 9 17 4 12"></polyline>
                                </svg>
                            </div>
                        ...
                        <div className="step-item">
                            ...
                            <p className="step-description">Coordination with your institution to ensure timely fund disbursement and ongoing financial support.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mobile-view">
                    <div className="header-title">
                        <h1 className="heading-big-medium">Getting Started</h1>
                        <p className="subheading-text">Secure your loan through a streamlined five-step process.</p>
                    </div>
                    <div className="mobile-timeline-container">
                        <div className="mobile-step-item">
                            <div className={`mobile-step-circle ${animationStage >= 0 ? 'animated-circle' : ''}`}>
                            ...
                            <div className="mobile-step-content">
                                <h3 className={`mobile-step-title ${animationStage >= 1 ? 'animated-text' : ''}`}>
                                    Schedule a Consultation
                                </h3>
                            </div>
                        </div>
                        <div className={`mobile-progress-line line1 ${animationStage >= 2 ? 'animated-line' : ''}`}></div>

                        <div className="mobile-step-item">
                            <div className={`mobile-step-circle ${animationStage >= 3 ? 'animated-circle' : ''}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            ...
                            <div className="mobile-step-content">
                                <h3 className={`mobile-step-title ${animationStage >= 4 ? 'animated-text' : ''}`}>
                                    Assessment of Needs
                                </h3>
                            </div>
                        </div>
                        <div className={`mobile-progress-line line2 ${animationStage >= 5 ? 'animated-line' : ''}`}></div>

                        <div className="mobile-step-item">
                            <div className={`mobile-step-circle ${animationStage >= 6 ? 'animated-circle' : ''}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            ...
                            <div className="mobile-step-content">
                                <h3 className={`mobile-step-title ${animationStage >= 7 ? 'animated-text' : ''}`}>
                                    Explore Loan Options
                                </h3>
                            </div>
                        </div>
                        <div className={`mobile-progress-line line3 ${animationStage >= 8 ? 'animated-line' : ''}`}></div>

                        <div className="mobile-step-item">
                            <div className={`mobile-step-circle ${animationStage >= 9 ? 'animated-circle' : ''}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            ...
                            <div className="mobile-step-content">
                                <h3 className={`mobile-step-title ${animationStage >= 10 ? 'animated-text' : ''}`}>
                                    Application & Approval
                                </h3>
                            </div>
                        </div>
                        <div className={`mobile-progress-line line4 ${animationStage >= 11 ? 'animated-line' : ''}`}></div>

                        <div className="mobile-step-item">
                            <div className={`mobile-step-circle ${animationStage >= 12 ? 'animated-circle' : ''}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            ...
                            <div className="mobile-step-content">
                                <h3 className={`mobile-step-title ${animationStage >= 13 ? 'animated-text' : ''}`}>
                                    Disbursement & Beyond
                                </h3>
                            </div>
                        </div>
