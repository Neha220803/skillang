...
const nurseCallenges = [
  ...
  { title: 'Language Barriers', text: 'We offer language courses and support for professional language certification.',img:nurseChallenge2 },
  { title: 'Cultural Adjustment', text: 'Our team provides cultural coaching and ongoing support for life and work in Germany.',img:nurseChallenge3 }
];
