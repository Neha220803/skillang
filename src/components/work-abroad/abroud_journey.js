                    ...
                    <div className="mobile-journey mobile-only">
                        <div className="mobile-timeline">
                            ...
                            <div className="mobile-step-container">
                                <div className={`mobile-step-icon ${animationStage >= 0 ? 'completed' : 'pending'}`}>
                                ...
                                <div className="mobile-step-text">
                                    <h3
                                        className={animationStage >= 1 ? 'active-step' : 'pending-step'}
                            ...
                            <div className={`mobile-connector-line ${animationStage >= 2 ? 'animated-line' : ''}`}></div>

                            {/* Second step */}
                            <div className="mobile-step-container">
                                <div className={`mobile-step-icon ${animationStage >= 3 ? 'completed' : 'pending'}`}>
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle
                                            cx="12"
                                            cy="12"
                                ...
                                <div className="mobile-step-text">
                                    <h3
                                        className={animationStage >= 4 ? 'active-step' : 'pending-step'}
                                        style={{ color: animationStage >= 4 ? "#00C170" : "#666" }}
                                    >
                                        CV Making, Application<br />& Interview Support
                                    </h3>
                                </div>
                            </div>

                            {/* Second Connector line */}
                            <div className={`mobile-connector-line ${animationStage >= 5 ? 'animated-line' : ''}`}></div>

                            {/* Third step */}
                            <div className="mobile-step-container">
                                <div className={`mobile-step-icon ${animationStage >= 6 ? 'completed' : 'pending'}`}>
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle
                                            cx="12"
                                            cy="12"
                                ...
                                <div className="mobile-step-text">
                                    <h3
                                        className={animationStage >= 7 ? 'active-step' : 'pending-step'}
