                    ...
                    <Col lg={5} md={6} sm={12} xs={12} className="d-flex align-items-start justify-content-center mt-3 p-0 mt-lg-0">
                        <Container className="d-flex align-items-center justify-content-center flex-column">
                            <div className="form-container m-0">
                                <div className="subheading-small-medium text-center mb-1">Start Your Work Abroad Journey</div>
                                <div className="mb-3 text-center paragraph-small-regular text-content-tertiary">Tell Us About Yourself!</div>
