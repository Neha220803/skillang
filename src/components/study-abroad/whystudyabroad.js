        ...
        <Container fluid="lg" className="">
            ...
            <Row className="align-items-center">
                <Col md={7} className="content">
                    ...
                    <p className='paragraph-big-medium text-content-secondary mt-1'>Free German Courses, Online & In-Person Training & Flexible Learning Schedules all in One Place</p>
